...
export function MapOnboarding() {
  return (
    <section className="mx-auto max-w-4xl py-8" aria-label="First connection">
      ...
      <p className="mt-6 text-xs uppercase tracking-widest text-base-content/75">No services yet</p>
      ...
      <p className="mt-6 text-xs text-base-content/75">Traces draw the application relationships. Network flows can add connections that traces do not observe.</p>
    </section>
  );
}
